...
@Component({
  ...
  styles: ['.month-picker-wrapper{position:relative;}.month-picker{position:absolute;padding:5px;top:100%;border:1pxsolid#d5d5d5;border-radius:3px;width:220px;height:220px;background-color:#fff;color:#44515c;font-size:11px;font-family:"Roboto",sans-serif;line-height:16px;font-weight:400;}.month-picker-header{display:flex;align-items:center;justify-content:space-between;margin-bottom:5px;.left{width:30px;height:30px;display:block;background-repeat:no-repeat;background-position:center;background-image:url("../assets/left.svg");cursor:pointer;background-size:12px;border-radius:3px;&:hover{background-color:#e1e8ed;}&.is-disabled{cursor:default;pointer-events:none;}}.title{padding:5px;display:block;cursor:pointer;}.right{width:30px;height:30px;display:block;background-repeat:no-repeat;background-position:center;background-image:url("../assets/right.svg");cursor:pointer;background-size:12px;border-radius:3px;&:hover{background-color:#e1e8ed;}&.is-disabled{cursor:default;pointer-events:none;}}}.month-picker-content{margin-bottom:5px;.month-block{display:flex;flex-wrap:wrap;.month-content{display:flex;align-items:center;justify-content:center;width:33.33%;border-radius:3px;cursor:pointer;height:37px;&.is-disabled{color:#ccc;background:#fbefef;cursor:default;pointer-events:none;}&.is-selected{background-color:#b3e4d5;cursor:default;}&:hover{background-color:#f4f7fc;}}}.year-block{display:flex;flex-wrap:wrap;.year-content{display:flex;align-items:center;border-radius:3px;justify-content:center;cursor:pointer;width:20%;height:29px;&.is-disabled{color:#ccc;background:#fbefef;cursor:default;pointer-events:none;}&.is-selected{background-color:#b3e4d5;cursor:default;}&:hover{background-color:#f4f7fc;}}}}.month-picker-footer{text-align:center;}'],
